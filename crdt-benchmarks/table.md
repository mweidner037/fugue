...
| :- |  -: | -: | -: | -: | -: | -:  |
|[B1.1] Append N characters (time)                                         |          190 ms |          249 ms |          234 ms |          147 ms |          867 ms |          162 ms |
...
|[B1.1] Append N characters (parseTime)                                    |           60 ms |           74 ms |          133 ms |           79 ms |          116 ms |          129 ms |
...
|[B1.2] Insert string of length N (memUsed)                                |         17.7 kB |           352 B |             0 B |          9.5 kB |          2.1 MB |        737.3 kB |
|[B1.2] Insert string of length N (parseTime)                              |           61 ms |           63 ms |           78 ms |           77 ms |          109 ms |          111 ms |
|[B1.3] Prepend N characters (time)                                        |          143 ms |           27 ms |           79 ms |          598 ms |          634 ms |          116 ms |
...
|[B1.4] Insert N characters at random positions (time)                     |          157 ms |          124 ms |          436 ms |          116 ms |          108 ms |          216 ms |
...
|[B1.4] Insert N characters at random positions (parseTime)                |           93 ms |           64 ms |          170 ms |          100 ms |          118 ms |          113 ms |
|[B1.5] Insert N words at random positions (time)                          |          181 ms |          415 ms |          676 ms |          147 ms |          336 ms |         2375 ms |
...
|[B1.5] Insert N words at random positions (parseTime)                     |          113 ms |           68 ms |          275 ms |          123 ms |          244 ms |          279 ms |
...
|[B1.6] Insert string, then delete it (parseTime)                          |           58 ms |           72 ms |          145 ms |           90 ms |          123 ms |          113 ms |
|[B1.7] Insert/Delete strings at random positions (time)                   |          188 ms |          119 ms |          575 ms |          186 ms |          331 ms |         1102 ms |
...
|[B1.7] Insert/Delete strings at random positions (parseTime)              |           90 ms |           69 ms |          237 ms |           95 ms |          149 ms |          147 ms |
|[B1.8] Append N numbers (time)                                            |          174 ms |           36 ms |          268 ms |          133 ms |          864 ms |          111 ms |
...
|[B1.8] Append N numbers (memUsed)                                         |             0 B |             0 B |             0 B |             0 B |          2.2 MB |        651.1 kB |
|[B1.8] Append N numbers (parseTime)                                       |           65 ms |           72 ms |          168 ms |          105 ms |          125 ms |          128 ms |
...
|[B1.9] Insert Array of N numbers (parseTime)                              |           60 ms |           71 ms |          125 ms |           99 ms |          121 ms |          135 ms |
|[B1.10] Prepend N numbers (time)                                          |          145 ms |           33 ms |          405 ms |          575 ms |          501 ms |           98 ms |
|[B1.10] Prepend N numbers (avgUpdateSize)                                 |        32 bytes |        36 bytes |       120 bytes |        52 bytes |       171 bytes |       204 bytes |
|[B1.10] Prepend N numbers (encodeTime)                                    |            8 ms |            1 ms |           12 ms |           16 ms |           80 ms |          110 ms |
|[B1.10] Prepend N numbers (docSize)                                       |     35665 bytes |     65658 bytes |     26985 bytes |    107390 bytes |     74613 bytes |     76576 bytes |
|[B1.10] Prepend N numbers (memUsed)                                       |          1.7 MB |         83.9 kB |             0 B |          1.9 MB |          1.8 MB |        645.8 kB |
|[B1.10] Prepend N numbers (parseTime)                                     |           78 ms |           77 ms |          163 ms |          107 ms |          118 ms |          123 ms |
|[B1.11] Insert N numbers at random positions (time)                       |          163 ms |          142 ms |          448 ms |          116 ms |           98 ms |          199 ms |
...
|[B1.11] Insert N numbers at random positions (docSize)                    |     59137 bytes |     59152 bytes |     47744 bytes |     77385 bytes |     68041 bytes |     96438 bytes |
|[B1.11] Insert N numbers at random positions (memUsed)                    |          1.7 MB |             0 B |             0 B |             0 B |            2 MB |        657.4 kB |
|[B1.11] Insert N numbers at random positions (parseTime)                  |           84 ms |           75 ms |          161 ms |          108 ms |          119 ms |          126 ms |
...
|[B2.1] Concurrently insert string of length N at index 0 (docSize)        |     12152 bytes |     12152 bytes |      8009 bytes |     12289 bytes |     86415 bytes |     91289 bytes |
|[B2.1] Concurrently insert string of length N at index 0 (memUsed)        |             0 B |           240 B |             0 B |             0 B |          4.2 MB |          1.4 MB |
|[B2.1] Concurrently insert string of length N at index 0 (parseTime)      |           64 ms |           75 ms |          150 ms |           79 ms |          124 ms |          134 ms |
|[B2.2] Concurrently insert N characters at random positions (time)        |           94 ms |          367 ms |         1237 ms |          160 ms |          191 ms |          797 ms |
...
|[B2.3] Concurrently insert N words at random positions (time)             |          170 ms |         1044 ms |         2133 ms |          177 ms |          910 ms |        16991 ms |
...
|[B2.3] Concurrently insert N words at random positions (parseTime)        |          143 ms |          140 ms |          450 ms |          124 ms |          333 ms |          431 ms |
|[B2.4] Concurrently insert & delete (time)                                |          334 ms |         2978 ms |         4306 ms |          444 ms |         1497 ms |        64376 ms |
...
|[B2.4] Concurrently insert & delete (encodeTime)                          |           37 ms |            6 ms |          121 ms |           48 ms |          470 ms |          758 ms |
|[B2.4] Concurrently insert & delete (docSize)                             |    279172 bytes |    279172 bytes |    307360 bytes |    252660 bytes |    639895 bytes |    940637 bytes |
|[B2.4] Concurrently insert & delete (memUsed)                             |          9.2 MB |             0 B |             0 B |          4.7 MB |         37.8 MB |           14 MB |
|[B2.4] Concurrently insert & delete (parseTime)                           |          211 ms |          151 ms |          848 ms |          137 ms |          657 ms |          491 ms |
|[B3.4] 20√N clients concurrently insert text in Array (time)              |           86 ms |          291 ms |           44 ms |           32 ms |           38 ms |           41 ms |
|[B3.4] 20√N clients concurrently insert text in Array (updateSize)        |     52748 bytes |     52738 bytes |    277630 bytes |     77430 bytes |    229890 bytes |    282250 bytes |
|[B3.4] 20√N clients concurrently insert text in Array (encodeTime)        |            3 ms |            1 ms |           14 ms |           31 ms |           73 ms |           78 ms |
|[B3.4] 20√N clients concurrently insert text in Array (docSize)           |     26593 bytes |     26583 bytes |     83578 bytes |     86647 bytes |     62017 bytes |     63368 bytes |
|[B3.4] 20√N clients concurrently insert text in Array (memUsed)           |        850.2 kB |             0 B |             0 B |        890.7 kB |         63.3 kB |        424.7 kB |
|[B3.4] 20√N clients concurrently insert text in Array (parseTime)         |           86 ms |          128 ms |          165 ms |          114 ms |          154 ms |          126 ms |
|[B4] Apply real-world editing dataset (time)                              |         4804 ms |        50868 ms |        86220 ms |         2059 ms |        14270 ms |        93321 ms |
...
|[B4] Apply real-world editing dataset (encodeTime)                        |           23 ms |            2 ms |          675 ms |           13 ms |          577 ms |         1098 ms |
...
|[B4] Apply real-world editing dataset (parseTime)                         |           63 ms |            8 ms |        82025 ms |           16 ms |          413 ms |          626 ms |
|[B4] Apply real-world editing dataset (memUsed)                           |          2.5 MB |           712 B |             0 B |          1.5 MB |         64.1 MB |         23.8 MB |
