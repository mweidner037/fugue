...
| :- |  -: | -: | -: | -: | -: | -:  |
|[B1.1] Append N characters (time)                                         |          190 ms |          236 ms |          234 ms |          147 ms |          867 ms |          156 ms |
...
|[B1.1] Append N characters (parseTime)                                    |           60 ms |           68 ms |          133 ms |           79 ms |          116 ms |           85 ms |
|[B1.2] Insert string of length N (time)                                   |            1 ms |            0 ms |           20 ms |            3 ms |          694 ms |           70 ms |
...
|[B1.2] Insert string of length N (parseTime)                              |           61 ms |           61 ms |           78 ms |           77 ms |          109 ms |           93 ms |
|[B1.3] Prepend N characters (time)                                        |          143 ms |           25 ms |           79 ms |          598 ms |          634 ms |          122 ms |
|[B1.3] Prepend N characters (avgUpdateSize)                               |        27 bytes |        27 bytes |       116 bytes |        46 bytes |       164 bytes |       197 bytes |
|[B1.3] Prepend N characters (encodeTime)                                  |            4 ms |            0 ms |           10 ms |           11 ms |           66 ms |            6 ms |
...
|[B1.3] Prepend N characters (parseTime)                                   |           73 ms |           63 ms |          167 ms |           97 ms |          109 ms |           89 ms |
|[B1.4] Insert N characters at random positions (time)                     |          157 ms |          127 ms |          436 ms |          116 ms |          108 ms |          195 ms |
|[B1.4] Insert N characters at random positions (avgUpdateSize)            |        29 bytes |        29 bytes |       121 bytes |        42 bytes |       163 bytes |       209 bytes |
|[B1.4] Insert N characters at random positions (encodeTime)               |           11 ms |            0 ms |           11 ms |            6 ms |           76 ms |            7 ms |
...
|[B1.4] Insert N characters at random positions (memUsed)                  |        742.1 kB |             0 B |             0 B |        680.5 kB |          2.2 MB |        663.7 kB |
|[B1.4] Insert N characters at random positions (parseTime)                |           93 ms |           65 ms |          170 ms |          100 ms |          118 ms |           86 ms |
|[B1.5] Insert N words at random positions (time)                          |          181 ms |          425 ms |          676 ms |          147 ms |          336 ms |         2053 ms |
|[B1.5] Insert N words at random positions (avgUpdateSize)                 |        36 bytes |        36 bytes |       131 bytes |        50 bytes |       864 bytes |      1143 bytes |
|[B1.5] Insert N words at random positions (encodeTime)                    |           14 ms |            1 ms |           28 ms |           15 ms |          178 ms |           39 ms |
...
|[B1.5] Insert N words at random positions (parseTime)                     |          113 ms |           71 ms |          275 ms |          123 ms |          244 ms |          140 ms |
|[B1.6] Insert string, then delete it (time)                               |            2 ms |            1 ms |           35 ms |           66 ms |         1025 ms |          148 ms |
|[B1.6] Insert string, then delete it (avgUpdateSize)                      |      6053 bytes |      6053 bytes |      6333 bytes |     71836 bytes |   1208487 bytes |   1406487 bytes |
|[B1.6] Insert string, then delete it (encodeTime)                         |            0 ms |            0 ms |            4 ms |            3 ms |           48 ms |            6 ms |
|[B1.6] Insert string, then delete it (docSize)                            |        38 bytes |        38 bytes |      3991 bytes |       137 bytes |     17792 bytes |   1005834 bytes |
|[B1.6] Insert string, then delete it (memUsed)                            |             0 B |           664 B |           440 B |        201.1 kB |            2 MB |        722.1 kB |
|[B1.6] Insert string, then delete it (parseTime)                          |           58 ms |           66 ms |          145 ms |           90 ms |          123 ms |           90 ms |
|[B1.7] Insert/Delete strings at random positions (time)                   |          188 ms |          130 ms |          575 ms |          186 ms |          331 ms |          959 ms |
|[B1.7] Insert/Delete strings at random positions (avgUpdateSize)          |        31 bytes |        31 bytes |       135 bytes |        67 bytes |       603 bytes |       740 bytes |
|[B1.7] Insert/Delete strings at random positions (encodeTime)             |           14 ms |            1 ms |           23 ms |            4 ms |          107 ms |           23 ms |
...
|[B1.7] Insert/Delete strings at random positions (parseTime)              |           90 ms |           70 ms |          237 ms |           95 ms |          149 ms |          102 ms |
|[B1.8] Append N numbers (time)                                            |          174 ms |           34 ms |          268 ms |          133 ms |          864 ms |           89 ms |
|[B1.8] Append N numbers (avgUpdateSize)                                   |        32 bytes |        32 bytes |       125 bytes |        45 bytes |       171 bytes |       204 bytes |
|[B1.8] Append N numbers (encodeTime)                                      |            4 ms |            0 ms |           13 ms |            6 ms |           76 ms |           15 ms |
|[B1.8] Append N numbers (docSize)                                         |     35634 bytes |     35634 bytes |     26982 bytes |     47751 bytes |     74644 bytes |   1044655 bytes |
|[B1.8] Append N numbers (memUsed)                                         |             0 B |        453.4 kB |             0 B |             0 B |          2.2 MB |        670.6 kB |
|[B1.8] Append N numbers (parseTime)                                       |           65 ms |           70 ms |          168 ms |          105 ms |          125 ms |           92 ms |
...
|[B1.9] Insert Array of N numbers (encodeTime)                             |            1 ms |            0 ms |            4 ms |            9 ms |           87 ms |            8 ms |
|[B1.9] Insert Array of N numbers (docSize)                                |     35657 bytes |     35657 bytes |     26951 bytes |     47772 bytes |     74742 bytes |   1044807 bytes |
|[B1.9] Insert Array of N numbers (memUsed)                                |             0 B |           496 B |           640 B |             0 B |          2.1 MB |        584.1 kB |
|[B1.9] Insert Array of N numbers (parseTime)                              |           60 ms |           69 ms |          125 ms |           99 ms |          121 ms |           85 ms |
|[B1.10] Prepend N numbers (time)                                          |          145 ms |           29 ms |          405 ms |          575 ms |          501 ms |           83 ms |
|[B1.10] Prepend N numbers (avgUpdateSize)                                 |        32 bytes |        32 bytes |       120 bytes |        52 bytes |       171 bytes |       204 bytes |
|[B1.10] Prepend N numbers (encodeTime)                                    |            8 ms |            0 ms |           12 ms |           16 ms |           80 ms |            7 ms |
|[B1.10] Prepend N numbers (docSize)                                       |     35665 bytes |     35665 bytes |     26985 bytes |    107390 bytes |     74613 bytes |   1044722 bytes |
|[B1.10] Prepend N numbers (memUsed)                                       |          1.7 MB |             0 B |             0 B |          1.9 MB |          1.8 MB |          471 kB |
|[B1.10] Prepend N numbers (parseTime)                                     |           78 ms |           71 ms |          163 ms |          107 ms |          118 ms |           87 ms |
|[B1.11] Insert N numbers at random positions (time)                       |          163 ms |          145 ms |          448 ms |          116 ms |           98 ms |          159 ms |
|[B1.11] Insert N numbers at random positions (avgUpdateSize)              |        34 bytes |        34 bytes |       125 bytes |        48 bytes |       171 bytes |       216 bytes |
|[B1.11] Insert N numbers at random positions (encodeTime)                 |            8 ms |            1 ms |           12 ms |           13 ms |           80 ms |            6 ms |
...
|[B1.11] Insert N numbers at random positions (parseTime)                  |           84 ms |           73 ms |          161 ms |          108 ms |          119 ms |           77 ms |
...
|[B2.1] Concurrently insert string of length N at index 0 (parseTime)      |           64 ms |           73 ms |          150 ms |           79 ms |          124 ms |           90 ms |
|[B2.2] Concurrently insert N characters at random positions (time)        |           94 ms |          354 ms |         1237 ms |          160 ms |          191 ms |          640 ms |
...
|[B2.2] Concurrently insert N characters at random positions (encodeTime)  |            2 ms |            1 ms |           23 ms |           14 ms |           97 ms |           11 ms |
...
|[B2.2] Concurrently insert N characters at random positions (parseTime)   |          121 ms |           77 ms |          234 ms |           96 ms |          136 ms |           95 ms |
|[B2.3] Concurrently insert N words at random positions (time)             |          170 ms |          968 ms |         2133 ms |          177 ms |          910 ms |        14898 ms |
...
|[B2.3] Concurrently insert N words at random positions (encodeTime)       |            4 ms |            3 ms |           61 ms |           28 ms |          281 ms |           97 ms |
...
|[B2.3] Concurrently insert N words at random positions (parseTime)        |          143 ms |          122 ms |          450 ms |          124 ms |          333 ms |          303 ms |
|[B2.4] Concurrently insert & delete (time)                                |          334 ms |         2604 ms |         4306 ms |          444 ms |         1497 ms |        62469 ms |
...
|[B2.4] Concurrently insert & delete (encodeTime)                          |           37 ms |            5 ms |          121 ms |           48 ms |          470 ms |          196 ms |
...
|[B2.4] Concurrently insert & delete (parseTime)                           |          211 ms |          136 ms |          848 ms |          137 ms |          657 ms |          404 ms |
|[B3.4] 20√N clients concurrently insert text in Array (time)              |           86 ms |          253 ms |           44 ms |           32 ms |           38 ms |           37 ms |
...
|[B3.4] 20√N clients concurrently insert text in Array (encodeTime)        |            3 ms |            1 ms |           14 ms |           31 ms |           73 ms |           11 ms |
...
|[B3.4] 20√N clients concurrently insert text in Array (memUsed)           |        850.2 kB |             0 B |             0 B |        890.7 kB |         63.3 kB |          275 kB |
|[B3.4] 20√N clients concurrently insert text in Array (parseTime)         |           86 ms |          112 ms |          165 ms |          114 ms |          154 ms |          113 ms |
|[B4] Apply real-world editing dataset (time)                              |         4804 ms |        52988 ms |        86220 ms |         2059 ms |        14270 ms |        84651 ms |
...
|[B4] Apply real-world editing dataset (encodeTime)                        |           23 ms |            3 ms |          675 ms |           13 ms |          577 ms |          286 ms |
...
|[B4] Apply real-world editing dataset (parseTime)                         |           63 ms |            9 ms |        82025 ms |           16 ms |          413 ms |          429 ms |
|[B4] Apply real-world editing dataset (memUsed)                           |          2.5 MB |            32 B |             0 B |          1.5 MB |         64.1 MB |           24 MB |
